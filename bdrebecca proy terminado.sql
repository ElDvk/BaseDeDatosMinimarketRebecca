...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-11-2021 a las 23:09:07
...
(43, 'BOLETA', '2021-10-25', 6, 110.00, 'BB01', '025', '93.22', '16.78');
...
(20, '2021-01-30', 20, '1', 'OBSERVACION', 110, 25, 85, '20.00'),
(22, '2021-10-18', 23, 'ENTRADA', ' ', 40, 20, 20, '12.00');
...
(23, 'PCC013', 'PRODUCTO PRUEBA', 12.00, 5);
...
--
ALTER TABLE `comprobante`
  MODIFY `codigo_com` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

...
INSERT INTO `comprobante` (`codigo_com`, `codigo_tipocom`, `fechaCom`, `codigo_cli`, `precioTotal`, `serieCom`, `numeracionCom`) VALUES
(1, 'BOLETA', '2021-08-29', 1, 5.89, 'BB01', '001'),
(2, 'BOLETA', '2021-08-29', 2, 4.80, 'BB01', '002'),
(3, 'BOLETA', '2021-08-29', 3, 5.50, 'BB01', '003'),
(4, 'BOLETA', '2021-09-02', 4, 2.30, 'BB01', '004'),
(5, 'FACTUR', '2021-09-02', 5, 3.50, 'FF01', '001'),
(6, 'FACTUR', '2021-09-02', 6, 7.99, 'FF01', '002');
...
(12, 'CUS001', 'Cerveza Pack 6 un 310ml Cisqueña', 21.90, 5),
...
INSERT INTO `tipocomprobante` (`codigo_tipocom`, `nombreCom`) VALUES
('BOLETA', 'Boleta de venta'),
('FACTUR', 'Factura de venta');
...
--
ALTER TABLE `cliente`
  MODIFY `codigo_cli` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `comprobante`
--
ALTER TABLE `comprobante`
  MODIFY `codigo_com` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
